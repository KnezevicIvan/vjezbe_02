...
class VideotekaService:
    ...
    def dodajFilm(self, idFilma):
        film: Film = Film(idFilma, input("Naziv filma: "), Utils.unesiCijeliBroj("Godina filma: "))
        self.videoteka.dodajFilm(film)
        return idFilma + 1


    def dodajKorisnika(self, idKorisnika):
        korisnik: Korisnik = Korisnik(idKorisnika, input("Ime korisnika: "), input("Prezime korisnika: "))
    ...
    def akcijaFilm(self, akcija: PovijestAkcija):
        ...
        if film is not None:
            korisnik: Korisnik = self.videoteka.dohvatiKorinikaPoIDu(Utils.unesiCijeliBroj("Unesite ID korisnika: "))
    ...
    def ispisi(self):
        print("-----------------Filmovi-----------------")
        self.videoteka.ispisiFilmove()
        print("-----------------Korisnici-----------------")
        self.videoteka.ispisiKorisnike()
        print("-----------------Povijest-----------------")
        self.videoteka.ispisiPovijest()
